...
import (
	...
	apisCluster "github.com/displague/provider-equinix/apis/cluster"
	apisNamespaced "github.com/displague/provider-equinix/apis/namespaced"
	"github.com/displague/provider-equinix/config"
	"github.com/displague/provider-equinix/internal/clients"
	controllerCluster "github.com/displague/provider-equinix/internal/controller/cluster"
	controllerNamespaced "github.com/displague/provider-equinix/internal/controller/namespaced"
	"github.com/displague/provider-equinix/internal/features"
	"github.com/displague/provider-equinix/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Equinix APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Equinix APIs to scheme")
	...
	if canSafeStart {
		...
		kingpin.FatalIfError(controllerCluster.SetupGated(mgr, clusterOpts), "Cannot setup cluster-scoped Equinix controllers")
		kingpin.FatalIfError(controllerNamespaced.SetupGated(mgr, namespacedOpts), "Cannot setup namespaced Equinix controllers")
	} else {
		log.Info("Provider has missing RBAC permissions for watching CRDs, controller SafeStart capability will be disabled")
		kingpin.FatalIfError(controllerCluster.Setup(mgr, clusterOpts), "Cannot setup cluster-scoped Equinix controllers")
		kingpin.FatalIfError(controllerNamespaced.Setup(mgr, namespacedOpts), "Cannot setup namespaced Equinix controllers")
	}
